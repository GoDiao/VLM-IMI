...
high_image_folder = '/data/sunxr/LLM-Diff/data/lowlight/high'
low_image_folder = '/data/sunxr/LLM-Diff/data/lowlight/low'
prompt_folder = '/data/sunxr/LLM-Diff/data/lowlight/text'
output_txt_file = '/data/sunxr/LLM-Diff/data/lowlight_train.txt'
